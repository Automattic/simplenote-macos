...
// See https://github.com/olofhellman/VerifyNoBS
...
//
//   xcrun -sdk macosx swift buildscripts/VerifyNoBuildSettings.swift  --xcode  ${PROJECT_DIR}/${PROJECT_NAME}.xcodeproj/project.pbxproj
//
