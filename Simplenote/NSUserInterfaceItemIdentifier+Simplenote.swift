...
extension NSUserInterfaceItemIdentifier {
    ...
    static let noteSortCreatedMenuItem      = NSUserInterfaceItemIdentifier(rawValue: "noteSortCreatedMenuItem")
    static let noteSortUpdatedMenuItem      = NSUserInterfaceItemIdentifier(rawValue: "noteSortUpdatedMenuItem")
    static let noteSortReversedMenuItem     = NSUserInterfaceItemIdentifier(rawValue: "noteSortReversedMenuItem")
